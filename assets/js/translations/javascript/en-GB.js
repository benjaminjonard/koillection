...
t.add("statistics.items_added", "{0} %count% items added| {1} %count% item added| ]1,Inf[ %count% items added", "javascript", "en-GB");
t.add("statistics.users", "{0} %count% users| {1} %count% user| ]1,Inf[ %count% users", "javascript", "en-GB");
t.add("statistics.items", "{0} %count% items| {1} %count% item| ]1,Inf[ %count% items", "javascript", "en-GB");
