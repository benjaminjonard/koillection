...
final class Version20220917151134 extends AbstractMigration
{
    public function getDescription(): string
    {
        return '[Mysql] Add display_configuration for `koi_collection` and `koi_album`';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE koi_collection ADD CONSTRAINT FK_7AA7B057A4A07C77 FOREIGN KEY (items_display_configuration_id) REFERENCES koi_display_configuration (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_7AA7B057A4A07C77 ON koi_collection (items_display_configuration_id)');
        $this->addSql('ALTER TABLE koi_display_configuration ADD columns LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\'');
        ...
        foreach ($collections as $collection) {
            ...
            $showVisibility = $collection['items_list_show_visibility'] ? 1 : 0;
            $showActions = $collection['items_list_show_actions'] ? 1 : 0;
