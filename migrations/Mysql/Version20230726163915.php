...
final class Version20230726163915 extends AbstractMigration
{
    ...
    {
        return '[Mysql] Add table `koi_scrapper`';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE koi_scrapper ADD CONSTRAINT FK_8256B8887E3C61F9 FOREIGN KEY (owner_id) REFERENCES koi_user (id)');
    }
