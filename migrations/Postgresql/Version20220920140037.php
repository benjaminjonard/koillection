...
final class Version20220920140037 extends AbstractMigration
{
    public function getDescription(): string
    {
        return '[Postgresql] Add display_configurations for `koi_user`';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE koi_user ADD collections_display_configuration_id CHAR(36) DEFAULT NULL');
        $this->addSql('ALTER TABLE koi_user ADD wishlists_display_configuration_id CHAR(36) DEFAULT NULL');
        $this->addSql('ALTER TABLE koi_user ADD albums_display_configuration_id CHAR(36) DEFAULT NULL');
        $this->addSql('ALTER TABLE koi_user ADD CONSTRAINT FK_AC3250557C312570 FOREIGN KEY (collections_display_configuration_id) REFERENCES koi_display_configuration (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE koi_user ADD CONSTRAINT FK_AC325055D85B8037 FOREIGN KEY (wishlists_display_configuration_id) REFERENCES koi_display_configuration (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE koi_user ADD CONSTRAINT FK_AC325055ACBC164 FOREIGN KEY (albums_display_configuration_id) REFERENCES koi_display_configuration (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
