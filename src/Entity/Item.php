...
#[ApiResource(
    operations: [
        ...
        new GetCollection(),
        new Post(),
        new Post(uriTemplate: '/items/{id}/image', denormalizationContext: ['groups' => ['item:image']], inputFormats: ['multipart' => ['multipart/form-data']], openapi: new OpenApiOperation(summary: 'Upload the Item image.'))
    ],
