...
#[ApiResource(
    operations: [
        ...
        new GetCollection(),
        new Post(),
        new Post(uriTemplate: '/photos/{id}/image', denormalizationContext: ['groups' => ['photo:image']], inputFormats: ['multipart' => ['multipart/form-data']], openapi: new OpenApiOperation(summary: 'Upload the Photo image.')),
    ],
